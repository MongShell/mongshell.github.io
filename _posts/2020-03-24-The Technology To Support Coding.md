...
하나의 프로그래밍 언어에 대해 설명한 책은 많습니다.  
일반적으로 변수, 연산자, 조건문의 표현 방식 등 보편적인 내용으로 시작해서, 뒷부분에는 그 언어만의 특성에 대해 설명합니다.

그런데 여러 언어에 대해, 각 언어가 어떻게 분기문을 처리하고, 어떤 자료형을 가지며, 어떤 스코프 정책을 취하는가 에 대한 책은 없을 겁니다. 언어가 너무 다양하고, 빠르게 변하기 때문입니다. 그리고 여러 언어를 그런 식으로 종합하는 것이 큰 의미가 없기도 합니다.

하지만 프로그래밍 언어의 세계에서 언제 분기문, 반복문이 등장했는지, 스코프에 대한 개념이 어떻게 발달했는지 이해하는 것은 유용합니다.  
프로그래밍 언어가 발전하고 개선되는 방식을 보고 프로그래밍 언어란 어떤 것인지 더 명확하게 알 수 있습니다. 그리고 각 언어의 특성을 파악하면서 특정 언어가 무슨 목적으로 그러한 특성을 갖게 됐는지 알 수 있습니다.

우리는 모두 처음 배운 프로그래밍 언어가 있습니다.
처음에는 그 언어의 참 거짓의 표현, 타입 종류, 분기문 처리, 에러 처리, 스코프 정책 등을 학습합니다.
그리고 좀 더 학습하다보면 다른 언어가 가지고 있지 않은 그 언어어의 특성을 배우게 됩니다.
그 후, 우리가 다른 언어를 학습할 때 이렇게 처음 배운 언어가 기준이 됩니다.
이 언어는 이게 다르구나, 이렇게 하는구나, 이점이 편하고, 저 점이 특이하구나 정도로 이해합니다.

이 책은 그런 방식에서 벗어나게 합니다.  
우선 하나의 기능에 대해서 다양한 언어를 비교합니다. 그리고 해당 개념이 없던 시절의 언어와 비교합니다.
예전에는 전혀 없던 기능이 생기게 된 이유와, 변하는 과정을 설명합니다. 그리고 어떻게 자리잡아왔는지 설명합니다.
제목 그대로 '코딩을 지탱하는 기술'들에 대해 설명해줍니다.
그래서 이 책을 읽고 나면 프로그래밍 언어에 다르게 접근할 수 있습니다.

한 언어를 접할 때, 프로그래밍 언어라는 큰 틀로 언어를 파악할 수 있습니다.
그 틀 안에서 이 언어가 가지는 기능들이 어떤 역할을 하는지 알 수 있습니다.

한가지 언어에 대해, 기능을 순차적으로 설명하는 것을 종단식 설명이라고 한다면 이 책은 횡단식 설명이라고 할 수 있습니다. 그리고 시간이라는 축까지 더해져 역사적 설명이라고도 할 수 있습니다.
...
이 책을 다 읽고나니 저자가 목표한 것을 성공적으로 이뤘다고 생각됩니다.

이 책을 읽고 코딩실력이 나아지진 않습니다.
딱히 하나의 언어에 대해서 잘 알게 되지도 않습니다.
하지만 프로그래밍 언어라는 큰 관점의 보편적 기능을 알게 해줍니다.
프로그래밍 언어를 바라보는 통찰을 얻을 수 있습니다.

많은 추천을 받아서 읽어보았는데, 책 두께에 비해 많은 시간을 쏟아 꼼꼼하게 읽은 책입니다.
사실 내리 2번 읽었습니다. 처음에는 감탄하면서 빠르게 읽었고, 두번째에는 하나라도 놓치지 않기 위해 정독을 했습니다.

그리고 이 책이 매우 훌륭하다는 결론을 내렸습니다.

한가지 이상의 언어를 필요로 하는 모든 프로그래머들에게 추천합니다.
