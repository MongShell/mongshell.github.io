...
프로그래밍 언어가 발전하고 개선되는 방식을 보고 프로그래밍 언어가 어떤 것인지 더 명확하게 알 수 있습니다. 그리고 각 언어의 특성을 파악하면서 특정 언어가 무슨 목적으로 그러한 특성을 갖게 됐는지 알 수 있습니다.
...
이 언어는 이게 다르구나, 이렇게 하는구나, 이 점이 편하고, 저 점이 특이하구나 정도로 이해합니다. 이러한 과정은 서너가지 언어를 습득할 때 까지 유지됩니다.  
...
그래서 이 책을 읽고 나면 프로그래밍 언어라는 큰 틀로 언어를 파악할 수 있습니다.
그 틀 안에서 각 언어가 가지는 기능들이 어떤 역할을 하는지 알 수 있습니다.

한가지 언어에 대해, 기능을 순차적으로 설명하는 것을 종단식 설명이라고 한다면 이 책은 횡단식 설명이라고 할 수 있습니다. 그리고 시간이라는 축까지 더해져 역사적 설명이라고도 할 수 있겠습니다.
